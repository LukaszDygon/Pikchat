...
\end{itemize}
To run everything it should be sufficient to execute teh following from the /server folder, in the following order:
\begin{enumerate}
\item \texttt{mongod}
